...
function ChartTooltip({ active, payload, label }) {
  ...
  return (
    <div className="rounded-lg border border-border-color bg-bg-secondary p-3 shadow-xl">
...
function ScoreTooltip({ active, payload, label }) {
  ...
  return (
    <div className="min-w-[150px] rounded-lg border border-border-color bg-bg-secondary p-3 shadow-xl">
...
export function ScoreDistributionChart({ data, detailed = false }) {
  return (
    <ChartContainer>
      <BarChart data={data} margin={detailed ? { top: 20, right: 30, left: 0, bottom: 20 } : undefined}>
        ...
        <Legend wrapperStyle={detailed ? { paddingTop: '20px' } : undefined} />
